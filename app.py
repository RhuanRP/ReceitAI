...
st.set_page_config(
    page_title="ReceitAI - A inteligência cozinheira", 
    page_icon="Logo.png", 
    layout="wide",
...
if st.button("Enviar"):
    if ingredients:
        ...
        response = requests.post('http://localhost:5000/api/submit', json={"ingredients": ingredients_list, "restricao": restricao})
